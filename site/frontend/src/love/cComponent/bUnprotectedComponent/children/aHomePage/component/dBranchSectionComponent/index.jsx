        ...
        <div className="container px-5 py-24 mx-auto flex flex-wrap flex-col">
          ...
          {Redux.state.ReceivedObject?.Retrieve?.BranchRetrieve?.subBranches?.map((each, index) => (
            <React.Fragment key={index}>
              <div className={`flex flex-wrap text-center bg-[#07553B] dark:bg-[#CED46A] text-[#CED46A] dark:text-[#07553B] bg-opacity-60 px-4 py-6 rounded-lg ${activeBranchGroup === each.title ? "" : "hidden"}`}>
                      ...
                      <div className="h-full bg-[#CED46A] dark:bg-[#07553B] text-[#07553B] dark:text-[#CED46A] rounded-lg overflow-hidden">
                        ...
                        <div className="p-6">
                          ...
                          <div className="flex items-center flex-wrap ">
                            ...
                            <span className="mr-3 inline-flex items-center lg:ml-auto md:ml-0 ml-auto leading-none text-sm pr-3 py-1 border-r-2 border-[#07553B] dark:border-[#CED46A]">
