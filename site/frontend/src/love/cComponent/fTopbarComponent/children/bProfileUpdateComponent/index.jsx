          ...
          <div class="lg:w-4/6 mx-auto">
            ...
            <div class="flex flex-col sm:flex-row mt-10">
              <div class="sm:w-1/3 text-center sm:pr-8 sm:py-8">
                <div class="w-20 h-20 rounded-full inline-flex items-center justify-center bg-[#013DC4] dark:bg-[#E2D3F3] text-[#E2D3F3] dark:text-[#013DC4]">
              ...
              <div class="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-[#013DC4] dark:border-[#E2D3F3] sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
        ...
        <div class="container px-5 py-12 mx-auto">
          <div class="flex flex-wrap -m-4">
            ...
            <div class="p-4 xl:w-1/3 md:w-1/2 w-full">
              <div class="h-full p-6 rounded-lg border border-[#013DC4] dark:border-[#E2D3F3] flex flex-col relative overflow-hidden">
                    ...
                    <div className='mb-2 mt-1 flex flex-1 space-x-4 items-center'>
                      <p>
                        <Avatar>
                          ...
                          <AvatarFallback className="bg-[#013DC4] dark:bg-[#E2D3F3] text-[#E2D3F3] dark:text-[#013DC4]">
                ...
                <div className="w-full mb-2">
                  <div className="relative">
                    ...
                    <input 
                      className="w-full bg-[#E2D3F3] dark:bg-[#013DC4] bg-opacity-40 rounded border 
                        border-[#013DC4] dark:border-[#E2D3F3]
                        focus:border-[#E2D3F3] dark:focus:border-[#013DC4] 
                        focus:bg-[#013DC4] dark:focus:bg-[#E2D3F3] 
                        focus:text-[#E2D3F3] dark:focus:text-[#013DC4] 
                        focus:ring-2 
                        focus:ring-[#013DC4] dark:focus:ring-[#E2D3F3] 
              ...
              <div class="h-full p-6 rounded-lg border border-[#013DC4] dark:border-[#E2D3F3] flex flex-col relative overflow-hidden">
                ...
                <div className="w-full mb-2">
                  <div className="relative">
                    ...
                    <input 
                      className="mb-2 w-full bg-[#E2D3F3] dark:bg-[#013DC4] bg-opacity-40 rounded border 
                        border-[#013DC4] dark:border-[#E2D3F3]
                        focus:border-[#E2D3F3] dark:focus:border-[#013DC4] 
                        focus:bg-[#013DC4] dark:focus:bg-[#E2D3F3] 
                        focus:text-[#E2D3F3] dark:focus:text-[#013DC4] 
